...
export default function EWalletReminderScreen() {
  const navigate = useNavigate();
  const { ewallet, getProviderStyles } = useEWallet();
  const serviceType = ewallet.serviceType;
  const styles = getProviderStyles();

  const handleProceed = () => {
    navigate(getEWalletRoute(ROUTES.EWALLET_FEE, serviceType));
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-lg leading-relaxed mb-4">beyond human error.</p>
